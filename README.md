...
All reports show that recision ("pre" column) is consistantly low for the high risk. The recall ("rec" column) is 40-60 for low_risk in the first 4 reports but then rises to 87 in the last to reports. 
